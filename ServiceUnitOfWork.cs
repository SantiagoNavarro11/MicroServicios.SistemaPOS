...
namespace Core.PaginaWeb.Servicios
{
    /// <summary>
    ...
    public partial class ServiceUnitOfWork : IServiceUnitOfWork
    {
        ...
        /// </summary>
        private readonly ISistemaPosService _iSistemaPosService;
        ...
        /// </summary>
        public ISistemaPosService SistemaPosService => _iSistemaPosService ?? new SistemaPosService(_iDLUnitOfWork);
