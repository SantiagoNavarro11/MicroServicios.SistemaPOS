namespace Infrastructure.PaginaWeb.Extenciones
{
    ...
    public class ApplicationLifetimeEventsHostedService : IHostedService
    {
        ...
        {
            Console.WriteLine("MS de PaginaWeb iniciado", "information_source");
        }

        /// <summary>Método que se ejecuta cuando la aplicación se está deteniendo.</summary>
        private void OnStopping()
        {
            Console.WriteLine("Ms de PaginaWeb se está deteniendo", "warning");
            Thread.Sleep(10000);
        }
        ...
        {
            Console.WriteLine("Ms de PaginaWeb detenida", "warning");
            Thread.Sleep(10000);
        }
